...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Due to UAC, RustDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install FBPDesk to the system."),
        ...
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [FBPDesk Input] service."),
        ...
        ("doc_mac_permission", "https://FBPDesk.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next FBPDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running FBPDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verify FBPDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use FBPDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade FBPDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://FBPDesk.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent FBPDesk from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if FBPDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep FBPDesk background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the FBPDesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, RustDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, FBPDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, FBPDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: FBPDesk server OSS doesn't include this feature."),
        ...
        ("activation_enter_title", "Enter activation code to link this device"),
        ("activation_enter_placeholder", "Activation code format: XXX-XXX"),
        ("activation_enter_button", "Activate"),
        ("activation_enter_empty_error", "Please enter activation code"),
        ("activation_enter_error", "Activation failed: "),
        ("activation_device_id", "DeviceID: "),
        ("activation_device_activated_title", "Device is activated"),
        ("activation_license_required", "Device activation required"),
        ("activation_device_blocked_title", "Device can no longer be activated"),
