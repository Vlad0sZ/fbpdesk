...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Падключэнне да сеткі FBPDesk..."),
        ...
        ("install_tip", "У некаторых выпадках RustDesk можа працаваць няправільна на аддаленым вузле з-за UAC. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўстаноўкі FBPDesk у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам неабходна дазволіць FBPDesk правы доступу."),
        ("config_screen", "Для аддаленага доступу да працоўнага сталу вам неабходна дазволіць FBPDesk правы здымку экрана."),
        ...
        ("Language", "Мова"),
        ("Keep RustDesk background service", "Захаваць фонавую службу FBPDesk"),
        ...
        ("Show RustDesk", "Паказаць FBPDesk"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, неабходна дазволіць FBPDesk маніторынг уводу."),
        ("config_microphone", "Каб размаўляць з аддаленай старонкай, неабходна дазволіць FBPDesk запіс аўдыё."),
        ...
        ("verify_rustdesk_password_tip", "Пацвердзіць пароль FBPDesk"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсці, каго вы НЕ ВЕДАЕЦЕ і каму НЕ ДАВЕРАЕЦЕ, і ён просіць вас выкарыстаць FBPDesk і запусціць яго службу, не працягвайце і неадкладна адмяніце размову."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Абнавіце FBPDesk Server Pro да версіі {} або новейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа перашкаджаць правільнай працы FBPDesk на кіруючым баку."),
        ...
        ("powered_by_me", "На аснове FBPDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць толькі падключэнне пры адкрытым акне FBPDesk"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу FBPDesk"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Калі ласка, абнавіце кліент FBPDesk да версіі {} або навейшай на аддаленым баку!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
